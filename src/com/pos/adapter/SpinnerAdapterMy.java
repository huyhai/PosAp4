...
import com.pos.R;
import com.pos.controllibs.UserFunctions.HistoryModel;
import com.pos.controllibs.UserFunctions.SVModel;
...
public class SpinnerAdapterMy extends ArrayAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View row = inflater.inflate(R.layout.ii, parent, false);
	...
	public View getDropDownView(int position, View convertView, ViewGroup parent) {
		...
		LayoutInflater inflater =this.context. getLayoutInflater();
		View row = inflater.inflate(R.layout.mm, parent, false);
