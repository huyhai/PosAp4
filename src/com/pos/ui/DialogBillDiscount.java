		...
		builder.setNeutralButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(final DialogInterface dialog, final int id) {
				if (isPercent == 1) {
					...
					main.notifidataSubAndTotal(String.valueOf(CalculationUtils
							.calculatePercent(amountSub, Double
									.parseDouble(edDis.getText().toString()))));
					percentDis = edDis.getText().toString();
					dollarDis = "0";

				} else if (isPercent == 2) {
					MainActivity main = new MainActivity();
					main.notifidataSubAndTotal(edDis.getText().toString());
