		...
		builder.setPositiveButton("Confirm",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (!TextUtils.isEmpty(edunitprice.getText().toString())&&!TextUtils.isEmpty(edproductquality.getText().toString())&&!TextUtils.isEmpty(edproductname.getText().toString())) {
						ListOrderModel md = new ListOrderModel();
						String amount;
						amount = String.valueOf(Double.parseDouble(edunitprice
								.getText().toString())
								* Double.parseDouble(edproductquality.getText()
										.toString()));
