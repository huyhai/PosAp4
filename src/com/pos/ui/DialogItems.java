...
public class DialogItems implements OnItemSelectedListener {
	...
	public void showDialogAddItem(final Context context, final Activity _ac,
		...
		SpinnerAdapterMy adapter1 = new SpinnerAdapterMy(ac, R.layout.ii,
				...
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						if (checkConstraint()) {
							...
							exportDB(tvNameImagei.getText().toString(), nextSessionId());
							if (isedit) {
								...
								ditem.UpdateItem(edItemName.getText()
										...
										.getText().toString(), realImage, edBarcode
										.getText().toString(), edUom.getText()
										.toString(), edCostPrice.getText()
										.toString(), edPrice.getText()
										.toString(), edPrice2.getText()
										.toString(), edPriceSpecial.getText()
										.toString(), edRemarks.getText()
										.toString(),groupID,textsize);
								...
								if (!TextUtils.isEmpty(edItemName.getText()
									...
									PayDataSource pay = new PayDataSource(ac,
											ac);
									long a = pay.insertInventoryReportAddnew(
											up1,
											edRemarks.getText().toString(), ac,edCostPrice.getText().toString());
